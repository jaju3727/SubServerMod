...
public class UpgradeCraftingScreen extends AbstractContainerScreen<UpgradeCraftingContainer> {
    private final UpgradeCraftingBlockEntity blockEntity;

    public UpgradeCraftingScreen(UpgradeCraftingContainer container, Inventory inv, Component title) {
