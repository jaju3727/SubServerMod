package net.jaju.subservermod.screen.subclass.miner.upgrade_crafting;
...
public class UpgradeCraftingContainer extends AbstractContainerMenu {
    private final UpgradeCraftingBlockEntity blockEntity;
    private final ContainerLevelAccess access;

    public UpgradeCraftingContainer(int id, Inventory playerInventory, BlockPos pos) {
        super(ModContainers.UPGRADE_CRAFTING_MENU.get(), id);
        this.blockEntity = (UpgradeCraftingBlockEntity) playerInventory.player.level().getBlockEntity(pos);
    ...
    public boolean stillValid(Player player) {
        return stillValid(access, player, ModBlocks.UPGRADE_CRAFTING_BLOCK.get());
    }
    ...
    public UpgradeCraftingBlockEntity getBlockEntity() {
        return blockEntity;
    }
}