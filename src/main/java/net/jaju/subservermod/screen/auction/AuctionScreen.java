package net.jaju.subservermod.screen.auction;
...
import net.jaju.subservermod.network.coinsystem.CoinDataRequestFromAuctionPacket;
...
//        if (Objects.equals(buyAuctionItem.playerUUID().toString(), player.getUUID().toString())) {
//            player.sendSystemMessage(Component.literal("자신이 올린 물건은 구매할 수 없습니다."));
//            return;
//        }
        ...
        if (boughtAmount > 0) {
            ...
            ItemStack coinItem = switch (coinType) {
                case "sub_coin" -> new ItemStack(ModItems.SUB_COIN.get());
                case "chef_coin" -> new ItemStack(ModItems.CHEF_COIN.get());
                case "farmer_coin" -> new ItemStack(ModItems.FARMER_COIN.get());
                case "fisherman_coin" -> new ItemStack(ModItems.FISHERMAN_COIN.get());
                case "alchemist_coin" -> new ItemStack(ModItems.ALCHEMIST_COIN.get());
                case "miner_coin" -> new ItemStack(ModItems.MINER_COIN.get());
                case "woodcutter_coin" -> new ItemStack(ModItems.WOODCUTTER_COIN.get());
            ...
            ModNetworking.INSTANCE.sendToServer(new AddItemToMailboxPacket(buyAuctionItem.playerUUID(), coinItem));
