...
public class EncyclopediaManager {
    ...
    private static ItemStack returnSub(String num) {
        ItemStack subCoin = new ItemStack(ModItems.SUB_COIN.get(), 1);
    ...
    private static void addGifts() {
        ...
        addGift(20, List.of(returnSub("30"), new ItemStack((ModItems.HOLY_GRAIL.get()), 1)));
        addGift(30, List.of(returnSub("30"), new ItemStack((ModItems.CONSTRUNTING_ALLOW.get()), 1)));
        addGift(50, List.of(returnSub("60"),
                new ItemStack((ModItems.CLASS_FORMER_1.get()), 6)));
        ItemStack randomBoxItem = new ItemStack(ModItems.RANDOMBOX.get(), 1);
        ...
        addGift(150, List.of(returnSub("180"),
                new ItemStack((ModItems.CLASS_FORMER_2.get()), 6)));
        addGift(200, List.of(returnSub("300"),
                new ItemStack((ModItems.SPECIAL_STORE_TELEPORT.get()), 1)));
        addGift(250, List.of(returnSub("600"),
                new ItemStack((ModItems.CLASS_FORMER_3.get()), 1)));
