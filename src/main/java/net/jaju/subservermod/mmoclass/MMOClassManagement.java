...
public class MMOClassManagement {
    ...
    private static MMOClassManagement instance;

    // Singleton 패턴
    public static MMOClassManagement getInstance() {
        if (instance == null) {
            instance = new MMOClassManagement();
            instance.loadClassData();
        }
        return instance;
    }

    private MMOClassManagement() {
