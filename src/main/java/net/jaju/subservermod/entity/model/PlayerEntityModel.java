package net.jaju.subservermod.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class PlayerEntityModel extends HumanoidModel<PlayerEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Subservermod.MOD_ID, "player_entity"), "main");

    public PlayerEntityModel(ModelPart root) {
        super(root);
    }
