package net.jaju.subservermod.blocks.subclass.chef.chefblock;
            ...
            if (entity.getcookFlag()){
                ...
                if (cookTick > entity.getcookGauge() * 1000L) {
                    ...
                    if (itemStack.getItem() == Items.BEEF) {
                        ...
                        itemStacks.add(new ItemStack(ModItems.BEEF_STEAK.get()));
                        ...
                        itemStacks.remove(itemStack);
                        itemStacks.add(new ItemStack(ModItems.PORK_BELLY.get()));
                        int nextCount = entity.getCookingOilCount() - 1;
                        if (nextCount == 0) itemStacks.remove(0);
                        entity.setCookingOilCount(nextCount);
                    } else if (itemStack.getItem() == Items.CHICKEN) {
                        itemStacks.remove(itemStack);
                        itemStacks.add(new ItemStack(ModItems.ROAST_CHICKEN.get()));
                        int nextCount = entity.getCookingOilCount() - 1;
                        if (nextCount == 0) itemStacks.remove(0);
                        entity.setCookingOilCount(nextCount);
                    } else if (itemStack.getItem() == Items.MUTTON) {
                        itemStacks.remove(itemStack);
                        itemStacks.add(new ItemStack(ModItems.LAMB_STEAK.get()));
                        int nextCount = entity.getButterCount() - 1;
                        if (nextCount == 0) itemStacks.remove(0);
                        entity.setButterCount(nextCount);
                    } else if (itemStack.getItem() == Items.EGG) {
                        itemStacks.remove(itemStack);
                        itemStacks.add(new ItemStack(ModItems.FRIED_EGG.get()));
                        int nextCount = entity.getCookingOilCount() - 1;
                        if (nextCount == 0) itemStacks.remove(0);
                        entity.setCookingOilCount(nextCount);
                    }
            ...
            if (entity.getoverCookFlag()) {
                ...
                if (overCookTick > entity.getoverCookGauge() * 1000L) {
                    ...
                    for (Iterator<ItemStack> iterator = itemStacks.iterator(); iterator.hasNext();) {
                        ...
                        if (itemStack.getItem() == ModItems.BEEF_STEAK.get() || itemStack.getItem() == ModItems.PORK_BELLY.get() || itemStack.getItem() == ModItems.ROAST_CHICKEN.get() || itemStack.getItem() == ModItems.LAMB_STEAK.get() || itemStack.getItem() == ModItems.FRIED_EGG.get()) {
                            iterator.remove();
