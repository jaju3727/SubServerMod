...
import net.jaju.subservermod.commands.randombox.RandomBoxCommand;
...
import static net.jaju.subservermod.commands.randombox.RandomBoxCommand.loadRandomBoxes;
...
public class RandomBoxEventHandler {
    ...
    public static void onPlayerUseItem(PlayerInteractEvent.RightClickItem event) {
        ...
        if (itemStack.getItem() == ModItems.RANDOMBOX.get()) {
            loadRandomBoxes();
