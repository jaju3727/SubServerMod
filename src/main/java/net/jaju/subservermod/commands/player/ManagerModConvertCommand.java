package net.jaju.subservermod.commands.player;

import com.google.gson.JsonArray;
import net.jaju.subservermod.manager.player.InventoryManager;
import net.jaju.subservermod.manager.player.PlayerManager;
import net.jaju.subservermod.network.ModNetworking;
import net.jaju.subservermod.network.integrated_menu.TemporaryOpPacket;
...
public class ManagerModConvertCommand {
    @SubscribeEvent
