                                ...
                                .executes(context -> {
                                    ...
                                    if (playerCoins >= amount) {
                                        ItemStack coinItem = switch (coinType) {
                                            case "subcoin" -> new ItemStack(ModItem.SUB_COIN.get());
                                            case "chefcoin" -> new ItemStack(ModItem.CHEF_COIN.get());
                                            case "farmercoin" -> new ItemStack(ModItem.FARMER_COIN.get());
                                            case "fishermancoin" -> new ItemStack(ModItem.FISHERMAN_COIN.get());
                                            case "alchemistcoin" -> new ItemStack(ModItem.ALCHEMIST_COIN.get());
                                            case "minercoin" -> new ItemStack(ModItem.MINER_COIN.get());
                                            case "woodcuttercoin" -> new ItemStack(ModItem.WOODCUTTER_COIN.get());
